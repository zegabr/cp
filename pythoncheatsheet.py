...
a1,a2,...,an = map(int, stdin.readline().split()) #get n ints
...
math functions: ceil,floor,fabs,factorial,fsum,gcd,log,sqrt,hypot,acos,asin,atan,cos,sin,tan,degrees,radians,pi,pow as fpow
